									...
									<div class="col-4 mb-2">
										<div class="card">
											<div class="card-header d-flex justify-content-between">
												<div>${todo.title }</div>
												<div id="card-todo-status-${todo.no }">
													<span class="badge ${todo.statusClass }">${todo.status }</span>
												</div>
											</div>
											<div class="card-body">
												<div class="row mb-3">
													...
													<div class="col-3">
														<button type="button"
															...
															onclick="openTodoDetailModal(${todo.no})">
							...
							<div class="row">
								<div class="col-12 text-center">
									<button class="btn btn-outline-dark btn"
										onclick="showMoreTodo(${param.pagenum })" id="show-more-todo">
						...
						<div class="modal-footer">
							<span id="status-button" style="display: none;">
								...
								<button type="button" class="btn btn-success btn-sm"
									onclick="changeStatus('처리완료')" id="처리완료">처리완료</button>
								<button type="button" class="btn btn-info btn-sm"
									onclick="changeStatus('처리중')" id="처리중">처리중</button>
								<button type="button" class="btn btn-secondary btn-sm"
									onclick="changeStatus('보류')" id="보류">보류</button>
								<button type="button" class="btn btn-danger btn-sm"
									onclick="changeStatus('취소')" id="취소">취소</button>
							</span>
							<button type="button" class="btn btn-outline-dark btn-sm"
								data-dismiss="modal" id="닫기">닫기</button>
						</div>
					</div>
				</div>
			</div>
