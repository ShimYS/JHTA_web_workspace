...
<%
	...
	// 아이디에 해당하는 사용자정보도 존재하고, 비밀번호도 일치하는 경우에만 아래 수행문이 실행된다.
	// 1. 우리 사이트에 가입한 회원이고, 그 회원이 직접 로그인한 것이 맞음.
	// 2. 회원이 다른 서비스를 사용하는 동안 추가적인 회원정보 입력없이 모든 서비스를 사용하도록 할 것임.
	// 3. 회원이 지금 사용하고 있는 브라우저만 접근할 수 있는 객체(session)에 회원의 정보를 저장하고, 
	// 	   해당 브라우저로 요청하는 모든 JSP 페이지에서 회원의 정보를 획득할 수 있도록 한다.
